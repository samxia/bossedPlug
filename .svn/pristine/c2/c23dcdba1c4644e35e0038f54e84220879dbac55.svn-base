...
public interface KehuMapper {
     ...
     * This method corresponds to the database table kehu
     *
     ...
     * @mbggenerated Thu Jun 06 18:01:38 CST 2013
     */
    int deleteByPrimaryKey(String kehuNo);
    ...
    List<Kehu> selectByExampleOnPagination(KehuExample example);
     ...
     * @mbggenerated Thu Jun 06 18:01:38 CST 2013
     */
    Kehu selectByPrimaryKey(String kehuNo);
