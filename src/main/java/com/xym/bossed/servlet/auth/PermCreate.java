...
/**
 * Servlet implementation class PermCreate
 */
public class PermCreate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pms!=null)
		{
			jo.put("errorMsg","Permission name ["+pms.getPermissionName()+"] has existed.");
			response.getWriter().println(jo.toString());
		return;	
		}
		us.insertPermission(perm);
